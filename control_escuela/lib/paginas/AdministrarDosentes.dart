                        ...
                        child: Column(
                          children: <Widget>[
                            selecctGeneral(
                                ...
                                "docente",
                                bd.tabla_docente,
                                bd.campo_tabla_docente_nombre,
                                bd.campo_tabla_docente_apellido,
                                controlerDocente_nombre,
                                controlerIDSDosente),
                            botonEditarDosente(
                                context,
                                controlerIDSDosente,
                                controlerDocente_nombre,
                                controlerDocente_direccion,
                                controlerDocente_apellido,
                                controlerDocente_clave,
                                controlerDocente_correo,
                                controlerDocente_fecha_Nacimiento,
                                controlerDocente_id_tipo_usuario,
                                controlerDocente_telefon,
                                controlerDocente_usuario),
